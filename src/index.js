...
// let reconnectMultiplier: number = 1;
// let latestMongoError: Error;
...
// 	createSubscriptions(/* subscriptions array goes here */);
// }
// async function createSubscriptions(subscriptions: Array<Subscription> = []) {
...
var EventFramework_1 = require("./classes/EventFramework");
var eventFramework = new EventFramework_1.EventFramework('mongodb://localhost:27017/' + 'fundamentals?replicaSet=rs', []);
eventFramework.start();
